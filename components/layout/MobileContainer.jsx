...
export default function MobileContainer({ children }) {
  return (
    <div className="relative min-h-screen w-full bg-slate-950 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full max-w-md h-screen bg-[#030712] border-x border-slate-900 shadow-2xl flex flex-col justify-between overflow-hidden md:rounded-3xl md:h-[840px] md:max-h-[90vh] md:border">
